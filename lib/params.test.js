...
test('should parse correct path', () => {
    expect(parsePathParams({
        ...
        // path: '/version-shield-json/github/sbcgua/repo_name/src/zif.abap/attr_name',
        pathParameters: {
    ...
    expect(parsePathParams({
        // resource: '/version-shield-json/{sourcePath}',
        // path: '/version-shield-json/github/sbcgua/repo_name/src/zif.abap',
        pathParameters: {
...
test('should throw on incorrect path', () => {
    ...
    expect(() => parsePathParams({
        // resource: '/version-shield-json/{sourcePath}',
        // path: '/version-shield-json/github/sbcgua/repo_name/src/zif.abap/attr_name/extra',
        pathParameters: {
