...
test('should parse correct path', () => {
    expect(parsePathParams({
        ...
        // path: '/get-abap-version-shield-json/github/sbcgua/repo_name/src/zif.abap/attr_name',
        pathParameters: {
    ...
    expect(parsePathParams({
        // resource: '/get-abap-version-shield-json/{sourcePath}',
        // path: '/get-abap-version-shield-json/github/sbcgua/repo_name/src/zif.abap',
        pathParameters: {
...
test('should throw on incorrect path', () => {
    expect(() => parsePathParams({
        // resource: '/get-abap-version-shield-json/{sourcePath}',
        // path: '/get-abap-version-shield-json/',
        pathParameters: {
            sourcePath: ''
        },
    ...
    expect(() => parsePathParams({
        // resource: '/get-abap-version-shield-json/{sourcePath}',
        // path: '/get-abap-version-shield-json/github/sbcgua/repo_name/src/zif.abap/attr_name/extra',
        pathParameters: {
